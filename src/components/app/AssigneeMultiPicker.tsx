  ...
  return (
    <div className={cn(compact ? "space-y-1.5" : "space-y-2", className)}>
      <div className="overflow-hidden rounded-xl border border-border bg-card shadow-soft">
        <div
          className={cn(
            "border-b border-border bg-muted/25 px-3",
            compact ? "py-2" : "py-3",
          )}
        >
        ...
        <div className={cn("px-2", compact ? "py-1.5" : "py-2")}>
          ...
          <div
            className={cn(
              "app-scrollbar overflow-y-auto overscroll-contain rounded-lg border border-border/70 bg-background/50",
                  ...
                  return (
                    <li key={option.id}>
                      <label
                        htmlFor={checkboxId}
                        className={cn(
                          "flex cursor-pointer items-center gap-2.5 rounded-lg px-2 transition-colors hover:bg-muted/50",
