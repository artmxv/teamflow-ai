...
import { AlertCircle, Briefcase, Calendar, ListTodo, Mail, MapPin, Phone } from "lucide-react";
...
import { nameToInitials, workspaceRoleLabel } from "@/lib/auth/use-current-user";
        ...
        {profile && !profileQuery.isLoading && (
          <div className="space-y-6 py-4">
            <div className="flex items-start gap-3">
              <Avatar id={profile.id} initials={profile.avatar ?? nameToInitials(profile.name)} />
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-2">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {t("team.joined")}: {new Date(profile.joinedAt).toLocaleDateString()}
                  </span>
                </div>
              </div>
            </div>
            ...
            <section>
              ...
              <div className="space-y-3 rounded-xl border border-border bg-muted/20 p-4">
                ...
                <ContactRow
                  ...
                  value={profile.contact.location ?? t("team.notAdded")}
                  muted={!profile.contact.location}
                />
              </div>
            </section>
